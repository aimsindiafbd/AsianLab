...
const Navbar = () => {
  ...
  return (
    <div className='bg-[#009EC5] relative py-1 px-4 font-sm z-50'>
      ...
      <div className='hidden sm:flex items-center justify-between'>
        <ul className='flex gap-5 text-sm text-white'>
          <NavLink to='/' className='text-md uppercase font-medium'>
          Home
        ...
        <div className='flex items-center gap-6'>
          <div className='group relative'>
            <div className='flex items-center cursor-pointer gap-2'>
              <FaRegUser onClick={() => token ? null : navigate('/register')} className='text-white w-6 h-6' />
          ...
          <Link to='/cart' className='relative'>
            <CiShoppingCart className='w-12 h-12 text-white' />
            <p className="absolute -right-1 -top-0 text-center px-2.5 py-1.5 leading-4 bg-black text-white rounded-full text-[12px] font-bold">{getCartCount()}</p>
          </Link>
        </div>
      </div>
